...
<html>
    <head>
        <meta charset="utf-8">
        <title>FRONT - Menu manager</title>
        <!-- Latest compiled and minified CSS -->
        <link rel="stylesheet" href="bower_components/bootstrap/dist/css/bootstrap.min.css">
        <link rel="stylesheet" href="bower_components/domenu/jquery.domenu-0.95.77.css">
    ...
    <body>
        ...
        <script src="bower_components/domenu/jquery.domenu-0.95.77.min.js"></script>
